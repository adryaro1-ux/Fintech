...
class AplicacionEstudios:
    def __init__(self, ventana, telefono_clinica="0000"):
        ...
        # Ruta Actualizada y Portable del Icono
    ...
    def ejecutar_escaneo(self):
        # Pasamos el ID de la clínica actual para buscar precios en su Excel
        print(f"[DEBUG] Ejecutando escaneo para clínica ID: {self.clinica_actual}")
        res = self.escaner.escanear_estudios(self.clinica_actual)
        if res:
            for r in res:
