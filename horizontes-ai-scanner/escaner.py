...
class EscanerEstudios:
    ...
    def escanear_estudios(self):
        """Busca patrones de estudios médicos"""
    ...
    def determinar_precio(self, nombre):
        for key, p in self.precios_referencia.items():
            if key in nombre.lower(): return p
